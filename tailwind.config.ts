    ...
    extend: {
      ...
      colors: {
        ...
        sidebar: {
          ...
          primary: 'hsl(var(--sidebar-primary, 0 0% 20%))',
          'primary-foreground': 'hsl(var(--sidebar-primary-foreground, 35 30% 97%))',
          accent: 'hsl(var(--sidebar-accent, 36 57% 58%))',
          'accent-foreground': 'hsl(var(--sidebar-accent-foreground, 0 0% 100%))',
          border: 'hsl(var(--sidebar-border, 0 0% 88%))',
          ring: 'hsl(var(--sidebar-ring, 36 57% 58%))',
        },
      },
      borderRadius: {
        lg: 'var(--radius)',
